...
messiclgls <- clgls  %>%
  ...
  slice(3:22) #Slicing tibble so that it has data on Messi from 2008 to 2018
...
crisclgls <- clgls  %>%
  select(X1,X2,X3,X4,X5,X6,X7,X8,X9,X10,X11,X12)%>%
  slice(23:47) #Slicing tibble so that it has data on Ronaldo from 2008 to 2018
...
messiintgls <- intgls  %>%
  ...
  slice(3:19) #Slicing tibble so that it has data on Messi's stats for Argentina from 2008 to 2018
...
crisintgls <- intgls  %>%
  select(X1,X2,X3,X4,X5,X6,X7,X8)%>%
  slice(23:41) ##Slicing tibble so that it has data on Ronaldo's stats for Portugal from 2008 to 2018

...
```{r}
write_csv(messiAndRonaldoLaLigaLong, "messiAndRonaldoLaLigaLong.csv")
```
...
```{r}
#ChampionsLeague
messiAndRonaldoUEFA <- left_join(messiChampionsLeague, ronaldoChampionsLeague, by = "Season")

messiAndRonaldoUEFA <- messiAndRonaldoUEFA %>% rename(messiAppearances = "Appearances.x",
                                                          messiGoals = "Goals.x",
                                                          messiAssists = "Assists.x", 
                                                          ronaldoAppearances = "Appearances.y",
                                                          ronaldoGoals = "Goals.y",
...
```{r}
messiAndRonaldoUEFALong <- gather(messiAndRonaldoUEFA, key = "Player", value = "Appearances", messiAppearances, ronaldoAppearances)

messiAndRonaldoUEFALong <- gather(messiAndRonaldoUEFALong, key = "PlayerGoals", value = "Goals", messiGoals, ronaldoGoals)

messiAndRonaldoUEFALong <- gather(messiAndRonaldoUEFALong, key = "PlayerAssists", value = "Assists", messiAssists, ronaldoAssists)
```

```{r}
messiAndRonaldoUEFALong$Player <- as.factor(messiAndRonaldoUEFALong$Player)

levels(messiAndRonaldoUEFALong$Player)[levels(messiAndRonaldoUEFALong$Player) == "messiAppearances"] <- "Messi"

levels(messiAndRonaldoUEFALong$Player)[levels(messiAndRonaldoUEFALong$Player) == "ronaldoAppearances"] <- "Ronaldo"
```

```{r}
messiAndRonaldoUEFALong$PlayerGoals <- NULL
messiAndRonaldoUEFALong$PlayerAssists <- NULL
```

```{r}
messiAndRonaldoUEFALong <- messiAndRonaldoUEFALong %>% slice(-(21:80))
```

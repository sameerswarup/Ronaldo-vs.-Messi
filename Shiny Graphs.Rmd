...
![](https://mirage.mathcs.carleton.edu/s/f3e9d4dcd233b8eecc390/files/Math285/Assignments/pair-homework-3-pair-homework-3-team-3/Picture.jpg)


```{r}
inputPanel(
  selectInput("x_1", label = "Choose a dataset",
              choices = c("Messi vs Ronaldo" = "MessiRonaldoLonger",
                          "LaLiga" = "messiAndRonaldoLaLiga",
                          "UEFA" = "messiAndRonaldoUEFA")
              ),
  fluidRow(
    column(width = 12,
